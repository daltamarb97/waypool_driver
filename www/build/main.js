...
var TripsService = /** @class */ (function () {
    ...
    TripsService.prototype.cancelTrip = function (place, keyTrip, driverUid, trip) {
        //create a trip in Trip's node in database
        this.afDB.database.ref(place + '/trips/' + driverUid + '/' + keyTrip).update(trip);
    };
    ...
    TripsService.prototype.eliminateKeyTripUser = function (place, userId) {
        // set false to onTrip instance in driver's node
        this.afDB.database.ref(place + '/users/' + userId + '/keyTrip').remove();
    };
    TripsService.prototype.eliminateKeyUser = function (place, userId, reserveId) {
    ...
    TripsService.prototype.cancelUserFromReserve = function (place, driverUid, keyTrip, userId) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_fire__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_fire_database__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_fire_auth__ = __webpack_require__(301);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Daniel\Documents\waypool\prod\latest\driver\waypool_driver\src\app\app.html"*/'<ion-menu [content]="content">\n\n        <ion-header>\n\n          <ion-toolbar>\n\n            <ion-title>Menu</ion-title>\n\n          </ion-toolbar>\n\n        </ion-header>\n\n        <ion-content>\n\n          <ion-list>\n\n            <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n              <ion-icon style="margin-right: 10px; font-size: 26px;" name={{p.icon}}></ion-icon>      \n\n\n\n              {{p.title}}                \n\n            </button>\n\n          \n\n          </ion-list>\n\n\n\n        </ion-content>\n\n      </ion-menu>\n\n      \n\n      <ion-nav  #content [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\Daniel\Documents\waypool\prod\latest\driver\waypool_driver\src\app\app.html"*/
        }),
