...
var FindridePage = /** @class */ (function () {
    function FindridePage(geofireService, renderer, TripsService, afDB, navCtrl, SignUpService, modalCtrl, authenticationService, geolocation, zone, sendCoordsService, AngularFireAuth, alertCtrl, toastCtrl, app, sendUsersService, instancesService, firebaseNative, platform, fcm) {
    ...
    FindridePage.prototype.changeColor = function () {
    ...
    FindridePage.prototype.changeColor2 = function () {
        this.renderer.setElementStyle(this.buttonDisconected.nativeElement, 'border-width', '1px');
