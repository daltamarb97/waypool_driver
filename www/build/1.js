...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__myride__ = __webpack_require__(744);
...
var MyridePage = /** @class */ (function () {
    function MyridePage(navCtrl, SignUpService, toastCtrl, alertCtrl, navParams, callNumber, sendCoordsService, AngularFireAuth, sendUsersService, geofireServices) {
        ...
        this.SignUpService.getMyInfoDriver(this.driverUid)
            ...
            if (_this.pickingUsers.length == 0 && _this.pickedUpUsers.length == 0) {
                _this.hideImage = !_this.hideImage;
            }
            else {
                console.log("hola");
            }
