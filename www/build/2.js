...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__myride__ = __webpack_require__(827);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_call_number__ = __webpack_require__(356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_angularfire2_database__ = __webpack_require__(200);
...
var MyridePage = /** @class */ (function () {
    function MyridePage(navCtrl, SignUpService, actionSheetCtrl, TripsService, modalCtrl, toastCtrl, alertCtrl, navParams, callNumber, sendCoordsService, AngularFireAuth, sendUsersService, geofireServices, afDB) {
        var _this = this;
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            _this.TripsService.timeFinishedTrip(_this.SignUpService.userPlace, _this.userDriver.keyTrip, _this.driverUid, today);
                            console.log(_this.trip);
                            ...
                            setTimeout(function () {
                                ...
                                _this.TripsService.allTrips(_this.userDriver.company, _this.driverUid, _this.userDriver.keyTrip, _this.trip);
                                ...
                                _this.afDB.database.ref('allCities/' + _this.userDriver.city + '/allPlaces/' + _this.userDriver.company + '/zones').once('value').then(function (snap) {
                                    ...
                                    Object.getOwnPropertyNames(obj).forEach(function (key) {
                                        if (obj[key] === 2) {
                                            ...
                                            _this.TripsService.saveTripOnRecords(obj[key], _this.driverUid, _this.trip);
                                        }
                                    });
                                });
                                ///////////
