...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tabs__ = __webpack_require__(807);
...
var TabsPage = /** @class */ (function () {
    function TabsPage(signUpService, angularFireAuth) {
        ...
        this.tab1Root = 'WalletPage';
        this.tab2Root = 'FindridePage';
        this.tab3Root = 'MorePage';
    }
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Daniel\Documents\waypool\prod\waypool_driver\src\pages\tabs\tabs.html"*/'<ion-tabs #myTabs tabsHideOnSubPages="false" [selectedIndex]="1">\n\n   <ion-tab [root]="tab1Root" tabIcon="md-card" ></ion-tab>\n\n\n\n    <ion-tab [root]="tab2Root" tabIcon="md-car"></ion-tab>\n\n    \n\n\n\n    <ion-tab [root]="tab3Root" tabIcon="md-person" ></ion-tab>\n\n</ion-tabs>\n\n'/*ion-inline-end:"C:\Users\Daniel\Documents\waypool\prod\waypool_driver\src\pages\tabs\tabs.html"*/
        }),
