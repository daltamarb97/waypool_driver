...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reservetrip__ = __webpack_require__(828);
                            ...
                            if (trip.pendingUsers === null || trip.pendingUsers === undefined) {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (trip.type == 'origin') {
                                        ...
                                        _this.geocoder.geocode({ 'address': trip.houseAddr[0][0] }, function (results, status) {
                                            if (status === 'OK') {
                                        ...
                                        // geocoding of addresses 
                                        _this.geocoder.geocode({ 'address': trip.placeAddr[0][0] }, function (results, status) {
                                            if (status === 'OK') {
