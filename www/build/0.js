...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(795)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_moment__ = __webpack_require__(667);
                        ...
                        if (_this.userDriver.onTrip === true) {
                            ...
                            if (trip.pendingUsers === null || trip.pendingUsers === undefined) {
                                ...
                                _this.afDB.database.ref(_this.SignUpService.userPlace + '/reserves/' + _this.userUid + '/' + tripKeyTrip + '/pendingUsers').once('value').then(function (snapReserve) {
                                    ...
                                    _this.TripsService.createTripState(_this.SignUpService.userPlace, tripKeyTrip, _this.userUid);
                                    // this.navCtrl.pop();
