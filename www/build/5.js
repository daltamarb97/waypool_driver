...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__confirmdirection__ = __webpack_require__(737);
...
var ConfirmdirectionPage = /** @class */ (function () {
    ...
    ConfirmdirectionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-confirmdirection',template:/*ion-inline-start:"D:\Users\Daniel\Documents\WaypoolApp\merge1\waypool_driver\src\pages\confirmdirection\confirmdirection.html"*/'<ion-content>\n\n  <ion-icon name="md-close" class="close-icon text-white" (click)="dismiss()"></ion-icon>\n\n  <ion-card>\n\n      <h6 class="text-theme">¿Cuál es tu destino? (IMPORTANTE)</h6>\n\n      <ion-card-content>\n\n          <div class="ride-detail">\n\n            <button class="btn bg-light text-theme rounded" (click)="setGeoFireDestination()" [ngStyle]="{\'background-color\': buttonColor}">\n\n                Casa\n\n              <ion-icon name="home"></ion-icon>\n\n            </button>\n\n            <button class="btn bg-light text-theme rounded" (click)="setGeoFireOrigin()" [ngStyle]="{\'background-color\': buttonColor2}">\n\n                  Universidad\n\n                <ion-icon name="book"></ion-icon>\n\n              </button>\n\n              <button class="btn bg-light text-theme rounded" (click)="setGeoFireOrigin()" [ngStyle]="{\'background-color\': buttonColor3}">\n\n                C. Jurídico Uninorte\n\n              \n\n            </button>\n\n            <button class="btn bg-light text-theme rounded" (click)="setGeoFireOrigin()"[ngStyle]="{\'background-color\': buttonColor4}">\n\n              Hospital Uninorte\n\n            <ion-icon name="book"></ion-icon>\n\n          </button>\n\n          </div>\n\n      </ion-card-content>\n\n\n\n      <ion-card-content>\n\n          <div class="seats">\n\n              \n\n              <ion-row style="margin-top: 14px;justify-content: center">\n\n                  \n\n                  <ion-col col-8>\n\n                      <button class="btn bg-theme text-white rounded" style="width: 100%;font-size: .95rem;" (click)="acceptTrip()">Aceptar Viaje</button>\n\n                  </ion-col>\n\n              </ion-row>\n\n\n\n\n\n          </div>\n\n      </ion-card-content>\n\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"D:\Users\Daniel\Documents\WaypoolApp\merge1\waypool_driver\src\pages\confirmdirection\confirmdirection.html"*/
        }),
