...
import { NavController, ViewController, ModalController, NavParams, Tabs } from 'ionic-angular';
...
export class ConfirmpopupPage {
  ...
  constructor(public navCtrl: NavController, private afDB: AngularFireDatabase,public sendUsersService: sendUsersService, public SignUpService: SignUpService, public sendCoordsService: sendCoordsService,public modalCtrl: ModalController, private AngularFireAuth: AngularFireAuth, public viewCtrl:ViewController,public navParams: NavParams) {
