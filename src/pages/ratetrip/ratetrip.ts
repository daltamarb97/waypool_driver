...
title = 'calificacion de viaje';
  constructor(public navCtrl: NavController,public navParams: NavParams,private emailComposer: EmailComposer,public SignUpServices:SignUpService,private afDB: AngularFireDatabase, public SignUpService: SignUpService, private AngularFireAuth: AngularFireAuth, public sendfeedback:sendFeedbackService) {
    this.today = Date.now();
